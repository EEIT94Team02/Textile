...
public class SpringMVCJavaConfiguration extends WebMvcConfigurerAdapter {
	...
	*/
	 ...
	 public org.springframework.web.servlet.view.RedirectView announcement(){
		 org.springframework.web.servlet.view.RedirectView redirectView = new org.springframework.web.servlet.view.RedirectView();
		 	redirectView.setUrl("/announcement/announcement.jsp");
			redirectView.setContextRelative(true);
			return redirectView; 
	 }
	 @Bean(name={"/socail.v"})
	 public org.springframework.web.servlet.view.RedirectView socailList(){
		 org.springframework.web.servlet.view.RedirectView redirectView = new org.springframework.web.servlet.view.RedirectView();
		 	redirectView.setUrl("/socail/socail.jsp");
			redirectView.setContextRelative(true);
			return redirectView; 
	 }
