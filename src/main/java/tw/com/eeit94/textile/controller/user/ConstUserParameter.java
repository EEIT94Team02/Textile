...
public enum ConstUserParameter {
	EMAILFROM("textilesystem11@gmail.com"), UTF_8("UTF-8"), VALIDEMAIL_YES("Y"), VALIDEMAIL_NO("N"), VALIDPHONE_YES(
			"Y"), VALIDPHONE_NO("N"), KEEPLOGIN("1"), KEEPLOGIN_YES("Y"), KEEPLOGIN_NO("N"),;
