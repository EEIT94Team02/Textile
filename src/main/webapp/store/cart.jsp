							...
							<c:url value="/store/pShowImg.do" var="showImg" scope="page">
								...
								<div class="container">
									...
									<p>
										...
										<input type="button" class="btn btn-success btn-md" name="action" value="修改" />
										<input type="button" class="btn btn-danger btn-md" name="action" value="刪除" />
									</p>
								</div>
						</c:forEach>
							<div class="sum">
								...
								<p>
									<input type="button" name="action" class="btn btn-success btn-md" value="結帳" />
									<input type="button" name="action" class="btn btn-danger btn-md" value="清空購物車" />
									<input type="button" name="store" class="headTo btn btn-primary btn-md" value="繼續購物" />
...
$(function() {
	$(':button[name="action"]').on('click', function() {
		...
		if (action == "修改" || action == "刪除") {
			var id = $(this).parents('p').find('input[name="id"]').val();
			var amount = $(this).parents('p').find('input[name="amount"]').val();
			$('#postId').val(id);
	...
	$(':button[class*="headTo"]').on('click', function() {
