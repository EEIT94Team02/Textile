 ...
 * @version 2017/06/10
 */
public class CheckHintPasswordValidator implements ConstraintValidator<CheckHintPassword, String> {
	private String column;

	@Override
	public void initialize(CheckHintPassword constraintAnnotation) {
