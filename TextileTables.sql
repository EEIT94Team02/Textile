...
('Heart', 20, '送禮用', '美美的愛心，洋溢著滿滿的幸福。', 1, (SELECT BulkColumn FROM OPENROWSET(BULK 'C:\Textile\product\heart.jpg', SINGLE_BLOB) AS x), 35),
('Crystal', 10, '送禮用', '展現支持與鼓勵的首選。', 1, (SELECT BulkColumn FROM OPENROWSET(BULK 'C:\Textile\product\crystal.png', SINGLE_BLOB) AS x), 15),
('WaterDrop', 5, '送禮用', '想關心朋友，卻缺一個起手式？', 1, (SELECT BulkColumn FROM OPENROWSET(BUlK 'C:\Textile\product\waterdrop.png', SINGLE_BLOB) AS x), 7),
('LonerHeart', 5, '送禮用', '邊緣人求好友。', 0, (SELECT BulkColumn FROM OPENROWSET(BUlK 'C:\Textile\product\heartForLoner.jpg', SINGLE_BLOB) AS x), 7)
GO
...
('2017-05-10 15:15:12','動物','動物','好友',6),
...
('20170527000000040001','\Textile\album\4\-315301300.jpg','池塘','池塘',5,'一般'),
('20170527000000040002','\Textile\album\4\-315301302.jpg','山','山',5,'一般'),
('20170527000000040003','\Textile\album\4\-315301301.jpg','海','海',5,'一般'),
('20170629000000030001','\Textile\album\3\-237371731.jpg','帥氣的大頭貼','帥，不須解釋。',2,'大頭貼'),
('20170629000000050001','\Textile\album\5\-237371730.jpg','型男','愛運動的帥氣形男',6,'一般'),
('20170629000000060001','\Textile\album\6\-237371729.jpg','老鷹','老鷹',7,'一般'),
('20170629000000060002','\Textile\album\6\-237371728.jpg','松鼠','松鼠',7,'一般'),
('20170629000000060003','\Textile\album\6\-237371727.jpg','小貓','小貓',7,'一般'),
('20170629000000060004','\Textile\album\6\-237371726.jpg','猴子','猴子',7,'一般'),
('20170629000000070001','\Textile\album\7\-237371725.jpg','baby','baby',8,'一般')
GO
...
('2016-10-01 00:00:00', '2017-12-31 23:59:59' , '心動列車-愛情萬萬歲' , ' 網路活動' , '愛情的路上，有些朋友走的平坦順遂，有些朋友可能會有些許的波折。我們走的還算順遂，但身邊有些朋友是走得有些不順。希望能藉由我們的幫手，讓朋友們走的順利一些。最終的目的，是希望大家在面對愛情的這條道路上，能夠輕吐了一口氣，心中暗想，萬歲，萬歲，萬萬歲'),
('2014-01-01 09:00:00', '2017-12-31 17:30:00' , '郭元益糕餅博物館DIY體驗' , '桃園縣楊梅鎮幼獅工業區青年路9巷1號' , '郭元益自1867年創立至今，為保存台灣糕餅珍貴資產，於2001年3月創設郭元益糕餅博物館楊梅館；2002年8月成立糕餅博物館士林館，融合參觀、教學、推廣功能，將糕餅歷史與禮俗發展做最佳詮釋，因活動內容充實豐富、生動活潑，具寓教於樂之教學意義，榮獲全國網路票選為優質博物館。'),
('2014-01-01 09:00:00', '2017-12-31 17:30:00' , '台灣味噌釀造文化館DIY體驗' , '台灣味噌釀造文化館-	三村里西勢路701號' , '台灣味噌釀造文化館以『寓教於樂』為主軸，進而推廣『傳統釀造、健康飲食』等專業知識，館內除了開放民眾參觀，了解在地的傳承文化之外，還可以深刻了解如何生產符合「健康、美味、安全」的釀造食品，進而也開放民眾DIY味噌，以及提供美味料理食譜給予參觀工廠的民眾品嘗，使大家能夠親身體驗食品釀造的樂趣外，在家也可以自行料理好吃的料理。讓這在地的好味道以及健康概念的堅持，純釀在世界各地。'),
('2017-07-01 13:30:00', '2017-07-01 16:30:00' , '甜meme ─簡單無拘束聯誼' , '台北捷運古亭站附近' , '甜meme主辦人小樂和小樂的老公，是藉由參加無數次未婚聯誼活動而認識彼此的，對於聯誼，我們有很深的感情感觸，也很清楚我們該為單身朋友做些什麼，我們很簡單，這裡提供一個輕鬆簡單無拘束的聯誼方式，讓大家可以在這樣的氛圍下，以最真實的情感去認識朋友，官網裡有主辦人小樂成立甜meme的心情，和所有我們能為你妳做的事，如果你妳是單身朋友，請給甜meme一個機會，讓我們也能幫你妳找到幸福。')
GO
...
(1,2,'好友','2017-05-29 07:00', DEFAULT),
(2,1,'好友','2017-05-29 07:00', DEFAULT),
(1,3,'好友','2017-05-29 07:00', DEFAULT),
(3,1,'好友','2017-05-29 07:00', DEFAULT),
(1,4,'好友','2017-05-29 07:00', DEFAULT),
(4,1,'好友','2017-05-29 07:00', DEFAULT),
(1,5,'好友','2017-05-29 07:00', DEFAULT),
(5,1,'好友','2017-05-29 07:00', DEFAULT),
(1,6,'好友','2017-05-29 07:00', DEFAULT),
(6,1,'好友','2017-05-29 07:00', DEFAULT),
(1,7,'好友','2017-05-29 07:00', DEFAULT),
(7,1,'好友','2017-05-29 07:00', DEFAULT),
(1,8,'好友','2017-05-29 07:00', DEFAULT),
(8,1,'好友','2017-05-29 07:00', DEFAULT),
(1,9,'好友','2017-05-29 07:00', DEFAULT),
(9,1,'好友','2017-05-29 07:00', DEFAULT),
(1,10,'好友','2017-05-29 07:00', DEFAULT),
(10,1,'好友','2017-05-29 07:00', DEFAULT),
(1,11,'好友','2017-05-29 07:00', DEFAULT),
(11,1,'好友','2017-05-29 07:00', DEFAULT),
(1,12,'好友','2017-05-29 07:00', DEFAULT),
(12,1,'好友','2017-05-29 07:00', DEFAULT),
(1,13,'好友','2017-05-29 07:00', DEFAULT),
(13,1,'好友','2017-05-29 07:00', DEFAULT),
(1,14,'好友','2017-05-29 07:00', DEFAULT),
(14,1,'好友','2017-05-29 07:00', DEFAULT),
(1,15,'好友','2017-05-29 07:00', DEFAULT),
(15,1,'好友','2017-05-29 07:00', DEFAULT),
(1,16,'好友','2017-05-29 07:00', DEFAULT),
(16,1,'好友','2017-05-29 07:00', DEFAULT),
(1,17,'好友','2017-05-29 07:00', DEFAULT),
(17,1,'好友','2017-05-29 07:00', DEFAULT),
(1,18,'好友','2017-05-29 07:00', DEFAULT),
(18,1,'好友','2017-05-29 07:00', DEFAULT),
(1,19,'好友','2017-05-29 07:00', DEFAULT),
(19,1,'好友','2017-05-29 07:00', DEFAULT),
(1,20,'好友','2017-05-29 07:00', DEFAULT),
(20,1,'好友','2017-05-29 07:00', DEFAULT),
(1,21,'好友','2017-05-29 07:00', DEFAULT),
(21,1,'好友','2017-05-29 07:00', DEFAULT),
(1,22,'好友','2017-05-29 07:00', DEFAULT),
(22,1,'好友','2017-05-29 07:00', DEFAULT),
(1,23,'好友','2017-05-29 07:00', DEFAULT),
(23,1,'好友','2017-05-29 07:00', DEFAULT),
(1,24,'好友','2017-05-29 07:00', DEFAULT),
(24,1,'好友','2017-05-29 07:00', DEFAULT),
(1,25,'好友','2017-05-29 07:00', DEFAULT),
(25,1,'好友','2017-05-29 07:00', DEFAULT),
(1,26,'好友','2017-05-29 07:00', DEFAULT),
(26,1,'好友','2017-05-29 07:00', DEFAULT),
(1,27,'好友','2017-05-29 07:00', DEFAULT),
(27,1,'好友','2017-05-29 07:00', DEFAULT),
(1,28,'好友','2017-05-29 07:00', DEFAULT),
(28,1,'好友','2017-05-29 07:00', DEFAULT),
(1,29,'好友','2017-05-29 07:00', DEFAULT),
(29,1,'好友','2017-05-29 07:00', DEFAULT),
(1,30,'好友','2017-05-29 07:00', DEFAULT),
(30,1,'好友','2017-05-29 07:00', DEFAULT),
...
CREATE TABLE report (
	--使用流水號方式產生回報編號
	reptNo int IDENTITY primary key NOT NULL,
	--會員編號 
	mId int foreign key references member(mId) NOT NULL,
	--回報日期
	reptDate datetime NOT NULL,
	--回報類別
	reptType nvarchar(20) NOT NULL,
	--回報內容
	reptDetail nvarchar(MAX) NOT NULL,
	--管理員回覆內容
	replyDetail nvarchar(MAX) ,
	--目前回覆狀態 已回覆or未回覆
	--situation nvarchar(3) NOT NULL
	situation bit NOT NULL
);

INSERT INTO report
   VALUES (3, '2012-05-31 19:12:00.000','儲值','請問為什麼首儲沒有拿到獎勵積分,因為已經過了兩天了確都沒有看到消息所以才來詢問','親愛的會員您好：

客服團隊感謝您的支持與愛護，

關於您「儲值」的問題，若您未獲得獎勵點數，請您提供以下資料將協助進後續處理。

帳號：
儲值時間：
或是儲值完成的圖片

待您提供完成將請相關單位進行後續處理，處理完成將再另外通知，造成不便請您見諒。

若您尚有其他問題，歡迎您透過『聯絡客服支援https://tw.textile.net/report』發出【客服支援回報單】來詢問，
希望這次的回覆對您有幫助，您可以問卷的方式給予我們建議，以做為我們進步的依據！謝謝您！

客服團隊祝您有愉快的一天！',1);

INSERT INTO report
   VALUES (3, '2013-05-31 19:23:00.000','相簿','請問關於我想將相簿分享給朋友觀看但他說看不到','',0);

INSERT INTO report
   VALUES (3, '2012-05-31 19:12:00.000','活動','您好請問我剛剛發起活動過了三天了卻都沒人加入，是不是系統有問題?
','',0);

INSERT INTO report
   VALUES (3, '2012-05-31 19:12:00.000','商店','您好請問我購買了商品物品欄卻是空的,能否幫忙看一下
','',0);

--=-=-=-=-=-=-=-=-=-=-=- 黃 回報圖檔資料 -=-=-=-=-=-=-=-=-=-=-=--
CREATE TABLE reportImg (
	--流水號產生
	reptImgNo int IDENTITY primary key NOT NULL,
	imgPath nvarchar(max) NOT NULL,
	reptNo int foreign key references report(reptNo) NOT NULL
	--reptNo int NOT NULL
);

--儲值
INSERT INTO reportImg
   VALUES ('\album\3\-237384476reportdeal.jpg',1);

--相簿
INSERT INTO reportImg
   VALUES ('\album\3\-237384479reportalbum.jpg',2);

--活動
INSERT INTO reportImg
   VALUES ('\album\3\-237384477reportactivity.jpg',3);
 
--物品欄
INSERT INTO reportImg
   VALUES ('\album\3\-237384475reportitem.jpg',4);

--=-=-=-=-=-=-=-=-=-=-=- 黃 回報更新資料 -=-=-=-=-=-=-=-=-=-=-=--
CREATE TABLE reportUpdate (
	--編號 流水號
	reptUpNo int IDENTITY primary key NOT NULL,
	--日期
	reptUpDate datetime NOT NULL,
	--回報內容
	reptUpDetail nvarchar(MAX) NOT NULL,
	--管理員回覆內容
	replyUpDetail nvarchar(MAX),
	--關聯回報編號
	reptNo int foreign key references report(reptNo) NOT NULL
);

INSERT INTO reportUpdate
	VALUES('2012-06-03 19:12:00.000','您好關於獎勵積分已經收到了 謝謝','客服團隊感謝您的支持與愛護，
若您尚有其他問題，歡迎您透過『聯絡客服支援https://tw.Textile.net/report』發出【客服支援回報單】來詢問，
希望這次的回覆對您有幫助，您可以問卷的方式給予我們建議，以做為我們進步的依據！謝謝您！
客服團隊祝您有愉快的一天！',1)

--=-=-=-=-=-=-=-=-=-=-=- 黃 回報更新圖檔資料 -=-=-=-=-=-=-=-=-=-=-=--
CREATE TABLE reportUpdateImg (
	--流水號產生
	reptUpImgNo int IDENTITY primary key NOT NULL,
	imgUpPath nvarchar(max) NOT NULL,
	reptUpNo int foreign key references reportUpdate(reptUpNo) NOT NULL
	--reptNo int NOT NULL
);

INSERT INTO reportUpdateImg
   VALUES ('\album\3\-233897474reportitemok.jpg',1);
