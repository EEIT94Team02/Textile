...
('2016-06-20 17:35:23.075','Y','Y','N','N','juan336830@outlook.com','O4iF036PE3TjpWwHPPCSSQ==','Juan Salmon','2004-05-08','A190886062','M','臺北市','中山區','復興北路166號','0989836513','鄉民的長度','30cm',0,119,0,2,1,0,3,2,0,1,'Juan Salmon是個天然黑系鄰家哥哥，外表可能看不出來、但是他其實是一位偵探。(?!有紅色的刺蝟頭，眼睛是金色。平常身上可能帶著鐮刀、狼牙棒、護身符或是手槍。(這樣子沒問題嗎...','19700101999999990001'),
...
('2016-08-03 16:15:46.416','Y','Y','N','N','essie822611@gmail.com','O4iF036PE3TjpWwHPPCSSQ==','Essie Moore','1988-01-21','A230134834','F','臺北市','大安區','和平東路二段134號','0961650433','我媽的體重','87kg',9487,401,8,4,3,1,1,0,10,2,'Essie Moore有著淺紫色的日系中長髮，膚色是偏紅，瞳色一藍一綠。身高175cm，主要的穿著為斗篷，配件是翅膀和兔子娃娃。','19700101999999990002'),
...
('Heart', 20, '送禮用', '美美的愛心，洋溢著滿滿的幸福。', 1, (SELECT BulkColumn FROM OPENROWSET(BULK 'C:\Textile\workspace\Textile\src\main\webapp\image\product\heart.jpg', SINGLE_BLOB) AS x), 35),
('Crystal', 10, '送禮用', '展現支持與鼓勵的首選。', 1, (SELECT BulkColumn FROM OPENROWSET(BULK 'C:\Textile\workspace\Textile\src\main\webapp\image\product\crystal.png', SINGLE_BLOB) AS x), 15),
('WaterDrop', 5, '送禮用', '想關心朋友，卻缺一個起手式？', 1, (SELECT BulkColumn FROM OPENROWSET(BUlK 'C:\Textile\workspace\Textile\src\main\webapp\image\product\waterdrop.png', SINGLE_BLOB) AS x), 7),
('LonerHeart', 5, '送禮用', '邊緣人求好友。', 0, (SELECT BulkColumn FROM OPENROWSET(BUlK 'C:\Textile\workspace\Textile\src\main\webapp\image\product\heartForLoner.jpg', SINGLE_BLOB) AS x), 7)
GO
...
(4, '2017-03-07', 100, 100 * 1.4),
(30, '2017-03-12', 2000, 2000 * 1.4),
(23, '2017-03-14', 2000, 2000 * 1.4),
(13, '2017-03-17', 2000, 2000 * 1.4),
(16, '2017-03-21', 2000, 2000 * 1.4),
(3, '2017-04-07', 2000, 2000 * 1.4),
(19, '2017-04-12', 500, 500 * 1.4),
(5, '2017-04-27', 2000, 2000 * 1.4),
(3, '2017-05-10', 2000, 2000 * 1.4),
(8, '2017-05-14', 2000, 2000 * 1.4),
(1, '2017-05-29', 1000, 1000 * 1.4),
(1, '2017-05-31', 1000, 1000 * 1.4),
(9, '2017-06-02', 100, 100 * 1.4),
(3, '2017-06-08', 2000, 2000 * 1.4),
(17, '2017-06-27', 150, 150 * 1.4),
(25, '2017-06-29', 100, 100 * 1.4)
GO
